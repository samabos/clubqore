      ...
      <CardHeader>
        <div className="flex justify-between items-center">
          <div>
            ...
            <CardDescription>
              {isEditMode
                ? "Update the children's information (children don't get separate login accounts)"
                : "Add the children who will be club members (children don't get separate login accounts)"}
            </CardDescription>
          </div>
          <Button
            type="button"
          ...
          <div key={child.id} className="border border-gray-200 rounded-xl p-6">
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <FormItem>
                ...
                <Input
                  id={`child-${child.id}-position`}
                  value={child.position}
                  onChange={(e) =>
                    updateChildField(child.id, "position", e.target.value)
                  }
